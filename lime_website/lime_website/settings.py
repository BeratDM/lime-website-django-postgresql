"""
Django settings for lime_website project.
...
PROJECT_DIR = os.path.join(BASE_DIR, "lime_website")
...
ROOT_URLCONF = "lime_website.urls"
...
WSGI_APPLICATION = "lime_website.wsgi.application"
